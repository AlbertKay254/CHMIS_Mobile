...
import 'dart:convert';
import 'package:medical_app/pages/doctor/doctor_signup.dart';
        ...
        child: ListView(
          children: [
            const Icon(Icons.local_hospital_rounded,
                size: 80, color: Color.fromARGB(255, 3, 179, 167)),
            const SizedBox(height: 20),
            const Text(
              'Sign Up to CHMIS Mobile Today',
              ...
              child: TextButton(
                ...
                child: const Text(
                  ...
                  style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 3, 179, 167),
                  ),
                ),
              ),
            ),
